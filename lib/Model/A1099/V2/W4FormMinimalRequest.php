...
/**
 * W4FormMinimalRequest Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class W4FormMinimalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'W4FormMinimalRequest';
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling W4FormMinimalRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEmployeeFirstName($employee_first_name)
    {
        ...
        if ((mb_strlen($employee_first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $employee_first_name when calling W4FormMinimalRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEmployeeLastName($employee_last_name)
    {
        ...
        if ((mb_strlen($employee_last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $employee_last_name when calling W4FormMinimalRequest., must be bigger than or equal to 1.');
        }

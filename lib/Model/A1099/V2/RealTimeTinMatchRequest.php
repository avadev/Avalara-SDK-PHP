...
/**
 * RealTimeTinMatchRequest Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RealTimeTinMatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealTimeTinMatchRequest';
     ...
     * Sets tin_type
     *
     * @param string|null $tin_type The TIN type.
     *
     * @return self
     */
     ...
     * Sets tin
     *
     * @param string|null $tin The TIN to be submitted to TIN match.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The entity name to be submitted to TIN match.
     *
     * @return self
     */

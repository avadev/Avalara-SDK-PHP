...
/**
 * Form1099DivListItemResponse Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class Form1099DivListItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Form1099DivListItemResponse';
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Form1099DivListItemResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling Form1099DivListItemResponse., must be bigger than or equal to 1.');
        }

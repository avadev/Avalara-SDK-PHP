...
/**
 * CreateAndSendW9FormEmailRequest Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class CreateAndSendW9FormEmailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAndSendW9FormEmail_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['employee_first_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'employee_first_name', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['employee_last_name'] === null) {
            $invalidProperties[] = "'employee_last_name' can't be null";
        }
        if ((mb_strlen($this->container['employee_last_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'employee_last_name', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setEmployeeFirstName($employee_first_name)
    {
        ...
        if ((mb_strlen($employee_first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $employee_first_name when calling CreateAndSendW9FormEmailRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEmployeeLastName($employee_last_name)
    {
        ...
        if ((mb_strlen($employee_last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $employee_last_name when calling CreateAndSendW9FormEmailRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateAndSendW9FormEmailRequest., must be bigger than or equal to 1.');
        }

...
/**
 * Form1095CListItem Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class Form1095CListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Form1095CListItem';
    ...
    protected static $openAPITypes = [
        ...
        'offer_and_coverages' => '\Avalara\SDK\Model\A1099\V2\OfferAndCoverageRequest[]',
     ...
     *
     * @param string|null $plan_start_month Plan start month
     *
     * @return self
     */
     ...
     *
     * @return \Avalara\SDK\Model\A1099\V2\OfferAndCoverageRequest[]|null
     */
     ...
     *
     * @param \Avalara\SDK\Model\A1099\V2\OfferAndCoverageRequest[]|null $offer_and_coverages Offer and coverage information
     *
     * @return self
     */
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Form1095CListItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Form1095CListItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Form1095CListItem., must be bigger than or equal to 1.');
        }

...
class JobResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'upsert' => 'bool',
        'link' => 'string',
        'processed_forms' => '\Avalara\SDK\Model\A1099\V2\Get1099Form200Response[]'
    ];
    ...
    protected static $setters = [
        ...
        'upsert' => 'setUpsert',
        'link' => 'setLink',
        'processed_forms' => 'setProcessedForms'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['processed_forms'] = $data['processed_forms'] ?? null;
    }
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for the job
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Job type identifier. Will always be \"update_job\" for bulk upsert operations
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Current status of the job (e.g., Success, Failed, InProgress)
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Error message if the job failed, null otherwise
     *
     * @return self
     */
     ...
     *
     * @param int|null $total_processed Total number of forms processed. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     * Sets total_rows
     *
     * @param int|null $total_rows Total number of forms in the request. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     * Sets updated_valid
     *
     * @param int|null $updated_valid Number of forms updated and valid for e-filing and e-delivery. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     *
     * @param int|null $updated_no_email Number of forms updated and valid for e-filing but missing email or email is undeliverable. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     *
     * @param int|null $updated_invalid Number of forms updated but invalid for e-filing. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     *
     * @param int|null $skipped_duplicate Number of forms skipped because they would have updated a record already updated once in the request. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     *
     * @param int|null $skipped_multiple_matches Number of forms skipped because they matched multiple forms. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     * Sets not_found
     *
     * @param int|null $not_found Number of forms skipped because no matching form or issuer could be found. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     *
     * @param int|null $created_invalid Number of new forms created because no matching form could be found (and `upsert` was true) - with errors. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     *
     * @param int|null $created_no_email Number of new forms created because no matching form could be found (and `upsert` was true) - valid for e-filing but missing email or email is undeliverable. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     * Sets created_valid
     *
     * @param int|null $created_valid Number of new forms created because no matching form could be found (and `upsert` was true) - valid for e-filing and e-delivery. Value can be 0 or another value based on what the job has available
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link Link to access the job details
     *
     * @return self
     */
    ...
    /**
     * Gets processed_forms
     *
     * @return \Avalara\SDK\Model\A1099\V2\Get1099Form200Response[]|null
     */
    public function getProcessedForms()
    {
        return $this->container['processed_forms'];
    }

    /**
     * Sets processed_forms
     *
     * @param \Avalara\SDK\Model\A1099\V2\Get1099Form200Response[]|null $processed_forms List of processed forms returned when bulk-upsert processes ≤1000 records. Same format as GET /1099/forms response. Only available in bulk-upsert endpoint responses.
     *
     * @return self
     */

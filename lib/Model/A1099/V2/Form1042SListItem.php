...
/**
 * Form1042SListItem Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class Form1042SListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Form1042SListItem';
    ...
    const LOB_CODE_INDIVIDUAL = 'Individual';
    const LOB_CODE_GOVERNMENT_CONTRACTING_STATE = 'GovernmentContractingState';
    const LOB_CODE_TAX_EXEMPT_PENSION_TRUST = 'TaxExemptPensionTrust';
    const LOB_CODE_TAX_EXEMPT_CHARITABLE_ORGANIZATION = 'TaxExemptCharitableOrganization';
    const LOB_CODE_PUBLICLY_TRADED_CORPORATION = 'PubliclyTradedCorporation';
    const LOB_CODE_SUBSIDIARY_OF_PUBLICLY_TRADED_CORPORATION = 'SubsidiaryOfPubliclyTradedCorporation';
    const LOB_CODE_COMPANY_OWNERSHIP_BASE_EROSION_TEST = 'CompanyOwnershipBaseErosionTest';
    const LOB_CODE_COMPANY_DERIVATIVE_BENEFITS_TEST = 'CompanyDerivativeBenefitsTest';
    const LOB_CODE_COMPANY_ACTIVE_TRADE_OR_BUSINESS_TEST = 'CompanyActiveTradeOrBusinessTest';
    const LOB_CODE_DISCRETIONARY_DETERMINATION = 'DiscretionaryDetermination';
    const LOB_CODE_OTHER = 'Other';
    const LOB_CODE_NO_LOB_ARTICLE_IN_TREATY = 'NoLobArticleInTreaty';
    const EXEMPTION_CODE_CHAP3_TAX_RATE_DUE_TO_BACKUP_WITHHOLDING = 'TaxRateDueToBackupWithholding';
    const EXEMPTION_CODE_CHAP3_EFFECTIVELY_CONNECTED_INCOME = 'EffectivelyConnectedIncome';
    const EXEMPTION_CODE_CHAP3_EXEMPT_UNDER_IRC = 'ExemptUnderIrc';
    const EXEMPTION_CODE_CHAP3_INCOME_NOT_FROM_US_SOURCES = 'IncomeNotFromUsSources';
    const EXEMPTION_CODE_CHAP3_EXEMPT_UNDER_TAX_TREATY = 'ExemptUnderTaxTreaty';
    const EXEMPTION_CODE_CHAP3_PORTFOLIO_INTEREST_EXEMPT_UNDER_IRC = 'PortfolioInterestExemptUnderIrc';
    const EXEMPTION_CODE_CHAP3_QI_THAT_ASSUMES_PRIMARY_WITHHOLDING_RESPONSIBILITY = 'QiThatAssumesPrimaryWithholdingResponsibility';
    const EXEMPTION_CODE_CHAP3_WF_POR_WFT = 'WfPorWft';
    const EXEMPTION_CODE_CHAP3_US_BRANCH_TREATED_AS_US_PERSON = 'UsBranchTreatedAsUsPerson';
    const EXEMPTION_CODE_CHAP3_TERRITORY_FI_TREATED_AS_US_PERSON = 'TerritoryFiTreatedAsUsPerson';
    const EXEMPTION_CODE_CHAP3_QI_REPRESENTS_INCOME_EXEMPT = 'QiRepresentsIncomeExempt';
    const EXEMPTION_CODE_CHAP3_QSL_THAT_ASSUMES_PRIMARY_WITHHOLDING_RESPONSIBILITY = 'QslThatAssumesPrimaryWithholdingResponsibility';
    const EXEMPTION_CODE_CHAP3_PAYEE_SUBJECTED_TO_CHAPTER4_WITHHOLDING = 'PayeeSubjectedToChapter4Withholding';
    const EXEMPTION_CODE_CHAP3_QDD_THAT_ASSUMES_PRIMARY_WITHHOLDING_RESPONSIBILITY = 'QddThatAssumesPrimaryWithholdingResponsibility';
    const EXEMPTION_CODE_CHAP3_EXEMPT_UNDER_SECTION897_L = 'ExemptUnderSection897L';
    const EXEMPTION_CODE_CHAP3_EXEMPT_UNDER_SECTION892 = 'ExemptUnderSection892';
    const EXEMPTION_CODE_CHAP4_NOT_EXEMPT = 'NotExempt';
    const EXEMPTION_CODE_CHAP4_GRANDFATHERED_PAYMENT = 'GrandfatheredPayment';
    const EXEMPTION_CODE_CHAP4_EFFECTIVELY_CONNECTED_INCOME = 'EffectivelyConnectedIncome';
    const EXEMPTION_CODE_CHAP4_PAYEE_NOT_SUBJECT_TO_CHAPTER4_WITHHOLDING = 'PayeeNotSubjectToChapter4Withholding';
    const EXEMPTION_CODE_CHAP4_EXCLUDED_NONFINANCIAL_PAYMENT = 'ExcludedNonfinancialPayment';
    const EXEMPTION_CODE_CHAP4_FOREIGN_ENTITY_THAT_ASSUMES_PRIMARY_WITHHOLDING_RESPONSIBILITY = 'ForeignEntityThatAssumesPrimaryWithholdingResponsibility';
    const EXEMPTION_CODE_CHAP4_US_PAYEES_OF_PARTICIPATING_FFI = 'UsPayeesOfParticipatingFfi';
    const EXEMPTION_CODE_CHAP4_EXEMPT_FROM_WITHHOLDING_UNDER_IGA = 'ExemptFromWithholdingUnderIga';
    const EXEMPTION_CODE_CHAP4_DORMANT_ACCOUNT = 'DormantAccount';
    const EXEMPTION_CODE_CHAP4_OTHER_PAYMENT_NOT_SUBJECT_TO_CHAPTER4_WITHHOLDING = 'OtherPaymentNotSubjectToChapter4Withholding';
    const CHAP3_STATUS_CODE_US_WITHHOLDING_AGENT_FI = 'USWithholdingAgentFI';
    const CHAP3_STATUS_CODE_US_WITHHOLDING_AGENT_OTHER = 'USWithholdingAgentOther';
    const CHAP3_STATUS_CODE_TERRITORY_FI_TREATED_AS_US_PERSON = 'TerritoryFITreatedAsUSPerson';
    const CHAP3_STATUS_CODE_TERRITORY_FI_NOT_TREATED_AS_US_PERSON = 'TerritoryFINotTreatedAsUSPerson';
    const CHAP3_STATUS_CODE_US_BRANCH_TREATED_AS_US_PERSON = 'USBranchTreatedAsUSPerson';
    const CHAP3_STATUS_CODE_US_BRANCH_NOT_TREATED_AS_US_PERSON = 'USBranchNotTreatedAsUSPerson';
    const CHAP3_STATUS_CODE_US_BRANCH_ECI_PRESUMPTION_APPLIED = 'USBranchECIPresumptionApplied';
    const CHAP3_STATUS_CODE_PARTNERSHIP_OTHER_THAN_WITHHOLDING_FOREIGN_PARTNERSHIP = 'PartnershipOtherThanWithholdingForeignPartnership';
    const CHAP3_STATUS_CODE_WITHHOLDING_FOREIGN_PARTNERSHIP = 'WithholdingForeignPartnership';
    const CHAP3_STATUS_CODE_TRUST_OTHER_THAN_WITHHOLDING_FOREIGN_TRUST = 'TrustOtherThanWithholdingForeignTrust';
    const CHAP3_STATUS_CODE_WITHHOLDING_FOREIGN_TRUST = 'WithholdingForeignTrust';
    const CHAP3_STATUS_CODE_QUALIFIED_INTERMEDIARY = 'QualifiedIntermediary';
    const CHAP3_STATUS_CODE_QUALIFIED_SECURITIES_LENDER_QUALIFIED_INTERMEDIARY = 'QualifiedSecuritiesLenderQualifiedIntermediary';
    const CHAP3_STATUS_CODE_QUALIFIED_SECURITIES_LENDER_OTHER = 'QualifiedSecuritiesLenderOther';
    const CHAP3_STATUS_CODE_CORPORATION = 'Corporation';
    const CHAP3_STATUS_CODE_INDIVIDUAL = 'Individual';
    const CHAP3_STATUS_CODE_ESTATE = 'Estate';
    const CHAP3_STATUS_CODE_PRIVATE_FOUNDATION = 'PrivateFoundation';
    const CHAP3_STATUS_CODE_GOVERNMENT_OR_INTERNATIONAL_ORGANIZATION = 'GovernmentOrInternationalOrganization';
    const CHAP3_STATUS_CODE_TAX_EXEMPT_ORGANIZATION_SECTION501C_ENTITIES = 'TaxExemptOrganizationSection501cEntities';
    const CHAP3_STATUS_CODE_UNKNOWN_RECIPIENT = 'UnknownRecipient';
    const CHAP3_STATUS_CODE_ARTIST_OR_ATHLETE = 'ArtistOrAthlete';
    const CHAP3_STATUS_CODE_PENSION = 'Pension';
    const CHAP3_STATUS_CODE_FOREIGN_CENTRAL_BANK_OF_ISSUE = 'ForeignCentralBankOfIssue';
    const CHAP3_STATUS_CODE_NONQUALIFIED_INTERMEDIARY = 'NonqualifiedIntermediary';
    const CHAP3_STATUS_CODE_HYBRID_ENTITY_MAKING_TREATY_CLAIM = 'HybridEntityMakingTreatyClaim';
    const CHAP3_STATUS_CODE_WITHHOLDING_RATE_POOL_GENERAL = 'WithholdingRatePoolGeneral';
    const CHAP3_STATUS_CODE_WITHHOLDING_RATE_POOL_EXEMPT_ORGANIZATION = 'WithholdingRatePoolExemptOrganization';
    const CHAP3_STATUS_CODE_PAI_WITHHOLDING_RATE_POOL_GENERAL = 'PAIWithholdingRatePoolGeneral';
    const CHAP3_STATUS_CODE_PAI_WITHHOLDING_RATE_POOL_EXEMPT_ORGANIZATION = 'PAIWithholdingRatePoolExemptOrganization';
    const CHAP3_STATUS_CODE_AGENCY_WITHHOLDING_RATE_POOL_GENERAL = 'AgencyWithholdingRatePoolGeneral';
    const CHAP3_STATUS_CODE_AGENCY_WITHHOLDING_RATE_POOL_EXEMPT_ORGANIZATION = 'AgencyWithholdingRatePoolExemptOrganization';
    const CHAP3_STATUS_CODE_US_WITHHOLDING_AGENT_FOREIGN_BRANCH_OF_FI = 'USWithholdingAgentForeignBranchOfFI';
    const CHAP3_STATUS_CODE_QUALIFIED_DERIVATIVES_DEALER = 'QualifiedDerivativesDealer';
    const CHAP3_STATUS_CODE_FOREIGN_GOVERNMENT_INTEGRAL_PART = 'ForeignGovernmentIntegralPart';
    const CHAP3_STATUS_CODE_FOREIGN_GOVERNMENT_CONTROLLED_ENTITY = 'ForeignGovernmentControlledEntity';
    const CHAP3_STATUS_CODE_PUBLICLY_TRADED_PARTNERSHIP = 'PubliclyTradedPartnership';
    const CHAP3_STATUS_CODE_DISCLOSING_QUALIFIED_INTERMEDIARY = 'DisclosingQualifiedIntermediary';
    const CHAP4_STATUS_CODE_US_WITHHOLDING_AGENT_FI = 'UsWithholdingAgentFi';
    const CHAP4_STATUS_CODE_US_WITHHOLDING_AGENT_OTHER = 'UsWithholdingAgentOther';
    const CHAP4_STATUS_CODE_TERRITORY_FI_NOT_TREATED_AS_US_PERSON = 'TerritoryFiNotTreatedAsUsPerson';
    const CHAP4_STATUS_CODE_TERRITORY_FI_TREATED_AS_US_PERSON = 'TerritoryFiTreatedAsUsPerson';
    const CHAP4_STATUS_CODE_PARTICIPATING_FFI_OTHER = 'ParticipatingFfiOther';
    const CHAP4_STATUS_CODE_PARTICIPATING_FFI_REPORTING_MODEL2_FFI = 'ParticipatingFfiReportingModel2Ffi';
    const CHAP4_STATUS_CODE_REGISTERED_DEEMED_COMPLIANT_FFI_REPORTING_MODEL1_FFI = 'RegisteredDeemedCompliantFfiReportingModel1Ffi';
    const CHAP4_STATUS_CODE_REGISTERED_DEEMED_COMPLIANT_FFI_SPONSORED_ENTITY = 'RegisteredDeemedCompliantFfiSponsoredEntity';
    const CHAP4_STATUS_CODE_REGISTERED_DEEMED_COMPLIANT_FFI_OTHER = 'RegisteredDeemedCompliantFfiOther';
    const CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFI_OTHER = 'CertifiedDeemedCompliantFfiOther';
    const CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFIFFI_WITH_LOW_VALUE_ACCOUNTS = 'CertifiedDeemedCompliantFfiffiWithLowValueAccounts';
    const CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFI_NON_REGISTERING_LOCAL_BANK = 'CertifiedDeemedCompliantFfiNonRegisteringLocalBank';
    const CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFI_SPONSORED_ENTITY = 'CertifiedDeemedCompliantFfiSponsoredEntity';
    const CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFI_INVESTMENT_ADVISOR_OR_MANAGER = 'CertifiedDeemedCompliantFfiInvestmentAdvisorOrManager';
    const CHAP4_STATUS_CODE_NONPARTICIPATING_FFI = 'NonparticipatingFfi';
    const CHAP4_STATUS_CODE_OWNER_DOCUMENTED_FFI = 'OwnerDocumentedFfi';
    const CHAP4_STATUS_CODE_US_BRANCH_TREATED_AS_US_PERSON = 'UsBranchTreatedAsUsPerson';
    const CHAP4_STATUS_CODE_US_BRANCH_NOT_TREATED_AS_US_PERSON = 'UsBranchNotTreatedAsUsPerson';
    const CHAP4_STATUS_CODE_PASSIVE_NFFE_IDENTIFYING_SUBSTANTIAL_US_OWNERS = 'PassiveNffeIdentifyingSubstantialUsOwners';
    const CHAP4_STATUS_CODE_PASSIVE_NFFE_WITH_NO_SUBSTANTIAL_US_OWNERS = 'PassiveNffeWithNoSubstantialUsOwners';
    const CHAP4_STATUS_CODE_PUBLICLY_TRADED_NFFE_OR_AFFILIATE = 'PubliclyTradedNffeOrAffiliate';
    const CHAP4_STATUS_CODE_ACTIVE_NFFE = 'ActiveNffe';
    const CHAP4_STATUS_CODE_INDIVIDUAL = 'Individual';
    const CHAP4_STATUS_CODE_SECTION501_C_ENTITIES = 'Section501CEntities';
    const CHAP4_STATUS_CODE_EXCEPTED_TERRITORY_NFFE = 'ExceptedTerritoryNffe';
    const CHAP4_STATUS_CODE_EXCEPTED_NFFE_OTHER = 'ExceptedNffeOther';
    const CHAP4_STATUS_CODE_EXEMPT_BENEFICIAL_OWNER = 'ExemptBeneficialOwner';
    const CHAP4_STATUS_CODE_ENTITY_WHOLLY_OWNED_BY_EXEMPT_BENEFICIAL_OWNERS = 'EntityWhollyOwnedByExemptBeneficialOwners';
    const CHAP4_STATUS_CODE_UNKNOWN_RECIPIENT = 'UnknownRecipient';
    const CHAP4_STATUS_CODE_RECALCITRANT_ACCOUNT_HOLDER = 'RecalcitrantAccountHolder';
    const CHAP4_STATUS_CODE_NONREPORTING_IGAFII = 'NonreportingIgafii';
    const CHAP4_STATUS_CODE_DIRECT_REPORTING_NFFE = 'DirectReportingNffe';
    const CHAP4_STATUS_CODE_US_REPORTABLE_ACCOUNT = 'UsReportableAccount';
    const CHAP4_STATUS_CODE_NON_CONSENTING_US_ACCOUNT = 'NonConsentingUsAccount';
    const CHAP4_STATUS_CODE_SPONSORED_DIRECT_REPORTING_NFFE = 'SponsoredDirectReportingNffe';
    const CHAP4_STATUS_CODE_EXCEPTED_INTER_AFFILIATE_FFI = 'ExceptedInterAffiliateFfi';
    const CHAP4_STATUS_CODE_UNDOCUMENTED_PREEXISTING_OBLIGATION = 'UndocumentedPreexistingObligation';
    const CHAP4_STATUS_CODE_US_BRANCH_ECI_PRESUMPTION_APPLIED = 'UsBranchEciPresumptionApplied';
    const CHAP4_STATUS_CODE_ACCOUNT_HOLDER_OF_EXCLUDED_FINANCIAL_ACCOUNT = 'AccountHolderOfExcludedFinancialAccount';
    const CHAP4_STATUS_CODE_PASSIVE_NFFE_REPORTED_BY_FFI = 'PassiveNffeReportedByFfi';
    const CHAP4_STATUS_CODE_NFFE_SUBJECT_TO1472_WITHHOLDING = 'NffeSubjectTo1472Withholding';
    const CHAP4_STATUS_CODE_RECALCITRANT_POOL_NO_US_INDICIA = 'RecalcitrantPoolNoUsIndicia';
    const CHAP4_STATUS_CODE_RECALCITRANT_POOL_US_INDICIA = 'RecalcitrantPoolUsIndicia';
    const CHAP4_STATUS_CODE_RECALCITRANT_POOL_DORMANT_ACCOUNT = 'RecalcitrantPoolDormantAccount';
    const CHAP4_STATUS_CODE_RECALCITRANT_POOL_US_PERSONS = 'RecalcitrantPoolUsPersons';
    const CHAP4_STATUS_CODE_RECALCITRANT_POOL_PASSIVE_NFF_ES = 'RecalcitrantPoolPassiveNffEs';
    const CHAP4_STATUS_CODE_NONPARTICIPATING_FFI_POOL = 'NonparticipatingFfiPool';
    const CHAP4_STATUS_CODE_US_PAYEES_POOL = 'UsPayeesPool';
    const CHAP4_STATUS_CODE_QI_RECALCITRANT_POOL_GENERAL = 'QiRecalcitrantPoolGeneral';
    const CHAP4_STATUS_CODE_US_WITHHOLDING_AGENT_FOREIGN_BRANCH_OF_FI = 'UsWithholdingAgentForeignBranchOfFi';
    ...
    {
        return [
            self::LOB_CODE_INDIVIDUAL,
            self::LOB_CODE_GOVERNMENT_CONTRACTING_STATE,
            self::LOB_CODE_TAX_EXEMPT_PENSION_TRUST,
            self::LOB_CODE_TAX_EXEMPT_CHARITABLE_ORGANIZATION,
            self::LOB_CODE_PUBLICLY_TRADED_CORPORATION,
            self::LOB_CODE_SUBSIDIARY_OF_PUBLICLY_TRADED_CORPORATION,
            self::LOB_CODE_COMPANY_OWNERSHIP_BASE_EROSION_TEST,
            self::LOB_CODE_COMPANY_DERIVATIVE_BENEFITS_TEST,
            self::LOB_CODE_COMPANY_ACTIVE_TRADE_OR_BUSINESS_TEST,
            self::LOB_CODE_DISCRETIONARY_DETERMINATION,
            self::LOB_CODE_OTHER,
            self::LOB_CODE_NO_LOB_ARTICLE_IN_TREATY,
        ];
    }
    ...
    {
        return [
            self::EXEMPTION_CODE_CHAP3_TAX_RATE_DUE_TO_BACKUP_WITHHOLDING,
            self::EXEMPTION_CODE_CHAP3_EFFECTIVELY_CONNECTED_INCOME,
            self::EXEMPTION_CODE_CHAP3_EXEMPT_UNDER_IRC,
            self::EXEMPTION_CODE_CHAP3_INCOME_NOT_FROM_US_SOURCES,
            self::EXEMPTION_CODE_CHAP3_EXEMPT_UNDER_TAX_TREATY,
            self::EXEMPTION_CODE_CHAP3_PORTFOLIO_INTEREST_EXEMPT_UNDER_IRC,
            self::EXEMPTION_CODE_CHAP3_QI_THAT_ASSUMES_PRIMARY_WITHHOLDING_RESPONSIBILITY,
            self::EXEMPTION_CODE_CHAP3_WF_POR_WFT,
            self::EXEMPTION_CODE_CHAP3_US_BRANCH_TREATED_AS_US_PERSON,
            self::EXEMPTION_CODE_CHAP3_TERRITORY_FI_TREATED_AS_US_PERSON,
            self::EXEMPTION_CODE_CHAP3_QI_REPRESENTS_INCOME_EXEMPT,
            self::EXEMPTION_CODE_CHAP3_QSL_THAT_ASSUMES_PRIMARY_WITHHOLDING_RESPONSIBILITY,
            ...
            self::EXEMPTION_CODE_CHAP3_EXEMPT_UNDER_SECTION892,
        ];
    }
    ...
    {
        return [
            self::EXEMPTION_CODE_CHAP4_NOT_EXEMPT,
            self::EXEMPTION_CODE_CHAP4_GRANDFATHERED_PAYMENT,
            self::EXEMPTION_CODE_CHAP4_EFFECTIVELY_CONNECTED_INCOME,
            self::EXEMPTION_CODE_CHAP4_PAYEE_NOT_SUBJECT_TO_CHAPTER4_WITHHOLDING,
            ...
            self::EXEMPTION_CODE_CHAP4_US_PAYEES_OF_PARTICIPATING_FFI,
            self::EXEMPTION_CODE_CHAP4_EXEMPT_FROM_WITHHOLDING_UNDER_IGA,
            self::EXEMPTION_CODE_CHAP4_DORMANT_ACCOUNT,
            self::EXEMPTION_CODE_CHAP4_OTHER_PAYMENT_NOT_SUBJECT_TO_CHAPTER4_WITHHOLDING,
        ];
    }
    ...
    {
        return [
            self::CHAP3_STATUS_CODE_US_WITHHOLDING_AGENT_FI,
            self::CHAP3_STATUS_CODE_US_WITHHOLDING_AGENT_OTHER,
            self::CHAP3_STATUS_CODE_TERRITORY_FI_TREATED_AS_US_PERSON,
            self::CHAP3_STATUS_CODE_TERRITORY_FI_NOT_TREATED_AS_US_PERSON,
            self::CHAP3_STATUS_CODE_US_BRANCH_TREATED_AS_US_PERSON,
            self::CHAP3_STATUS_CODE_US_BRANCH_NOT_TREATED_AS_US_PERSON,
            self::CHAP3_STATUS_CODE_US_BRANCH_ECI_PRESUMPTION_APPLIED,
            self::CHAP3_STATUS_CODE_PARTNERSHIP_OTHER_THAN_WITHHOLDING_FOREIGN_PARTNERSHIP,
            self::CHAP3_STATUS_CODE_WITHHOLDING_FOREIGN_PARTNERSHIP,
            self::CHAP3_STATUS_CODE_TRUST_OTHER_THAN_WITHHOLDING_FOREIGN_TRUST,
            self::CHAP3_STATUS_CODE_WITHHOLDING_FOREIGN_TRUST,
            self::CHAP3_STATUS_CODE_QUALIFIED_INTERMEDIARY,
            self::CHAP3_STATUS_CODE_QUALIFIED_SECURITIES_LENDER_QUALIFIED_INTERMEDIARY,
            self::CHAP3_STATUS_CODE_QUALIFIED_SECURITIES_LENDER_OTHER,
            self::CHAP3_STATUS_CODE_CORPORATION,
            self::CHAP3_STATUS_CODE_INDIVIDUAL,
            self::CHAP3_STATUS_CODE_ESTATE,
            self::CHAP3_STATUS_CODE_PRIVATE_FOUNDATION,
            self::CHAP3_STATUS_CODE_GOVERNMENT_OR_INTERNATIONAL_ORGANIZATION,
            self::CHAP3_STATUS_CODE_TAX_EXEMPT_ORGANIZATION_SECTION501C_ENTITIES,
            self::CHAP3_STATUS_CODE_UNKNOWN_RECIPIENT,
            self::CHAP3_STATUS_CODE_ARTIST_OR_ATHLETE,
            self::CHAP3_STATUS_CODE_PENSION,
            self::CHAP3_STATUS_CODE_FOREIGN_CENTRAL_BANK_OF_ISSUE,
            self::CHAP3_STATUS_CODE_NONQUALIFIED_INTERMEDIARY,
            self::CHAP3_STATUS_CODE_HYBRID_ENTITY_MAKING_TREATY_CLAIM,
            self::CHAP3_STATUS_CODE_WITHHOLDING_RATE_POOL_GENERAL,
            self::CHAP3_STATUS_CODE_WITHHOLDING_RATE_POOL_EXEMPT_ORGANIZATION,
            self::CHAP3_STATUS_CODE_PAI_WITHHOLDING_RATE_POOL_GENERAL,
            self::CHAP3_STATUS_CODE_PAI_WITHHOLDING_RATE_POOL_EXEMPT_ORGANIZATION,
            self::CHAP3_STATUS_CODE_AGENCY_WITHHOLDING_RATE_POOL_GENERAL,
            self::CHAP3_STATUS_CODE_AGENCY_WITHHOLDING_RATE_POOL_EXEMPT_ORGANIZATION,
            self::CHAP3_STATUS_CODE_US_WITHHOLDING_AGENT_FOREIGN_BRANCH_OF_FI,
            self::CHAP3_STATUS_CODE_QUALIFIED_DERIVATIVES_DEALER,
            self::CHAP3_STATUS_CODE_FOREIGN_GOVERNMENT_INTEGRAL_PART,
            self::CHAP3_STATUS_CODE_FOREIGN_GOVERNMENT_CONTROLLED_ENTITY,
            self::CHAP3_STATUS_CODE_PUBLICLY_TRADED_PARTNERSHIP,
            self::CHAP3_STATUS_CODE_DISCLOSING_QUALIFIED_INTERMEDIARY,
        ];
    }
    ...
    {
        return [
            self::CHAP4_STATUS_CODE_US_WITHHOLDING_AGENT_FI,
            self::CHAP4_STATUS_CODE_US_WITHHOLDING_AGENT_OTHER,
            self::CHAP4_STATUS_CODE_TERRITORY_FI_NOT_TREATED_AS_US_PERSON,
            self::CHAP4_STATUS_CODE_TERRITORY_FI_TREATED_AS_US_PERSON,
            self::CHAP4_STATUS_CODE_PARTICIPATING_FFI_OTHER,
            self::CHAP4_STATUS_CODE_PARTICIPATING_FFI_REPORTING_MODEL2_FFI,
            self::CHAP4_STATUS_CODE_REGISTERED_DEEMED_COMPLIANT_FFI_REPORTING_MODEL1_FFI,
            self::CHAP4_STATUS_CODE_REGISTERED_DEEMED_COMPLIANT_FFI_SPONSORED_ENTITY,
            self::CHAP4_STATUS_CODE_REGISTERED_DEEMED_COMPLIANT_FFI_OTHER,
            self::CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFI_OTHER,
            self::CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFIFFI_WITH_LOW_VALUE_ACCOUNTS,
            self::CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFI_NON_REGISTERING_LOCAL_BANK,
            self::CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFI_SPONSORED_ENTITY,
            self::CHAP4_STATUS_CODE_CERTIFIED_DEEMED_COMPLIANT_FFI_INVESTMENT_ADVISOR_OR_MANAGER,
            self::CHAP4_STATUS_CODE_NONPARTICIPATING_FFI,
            self::CHAP4_STATUS_CODE_OWNER_DOCUMENTED_FFI,
            self::CHAP4_STATUS_CODE_US_BRANCH_TREATED_AS_US_PERSON,
            self::CHAP4_STATUS_CODE_US_BRANCH_NOT_TREATED_AS_US_PERSON,
            self::CHAP4_STATUS_CODE_PASSIVE_NFFE_IDENTIFYING_SUBSTANTIAL_US_OWNERS,
            self::CHAP4_STATUS_CODE_PASSIVE_NFFE_WITH_NO_SUBSTANTIAL_US_OWNERS,
            self::CHAP4_STATUS_CODE_PUBLICLY_TRADED_NFFE_OR_AFFILIATE,
            self::CHAP4_STATUS_CODE_ACTIVE_NFFE,
            self::CHAP4_STATUS_CODE_INDIVIDUAL,
            self::CHAP4_STATUS_CODE_SECTION501_C_ENTITIES,
            self::CHAP4_STATUS_CODE_EXCEPTED_TERRITORY_NFFE,
            self::CHAP4_STATUS_CODE_EXCEPTED_NFFE_OTHER,
            self::CHAP4_STATUS_CODE_EXEMPT_BENEFICIAL_OWNER,
            self::CHAP4_STATUS_CODE_ENTITY_WHOLLY_OWNED_BY_EXEMPT_BENEFICIAL_OWNERS,
            self::CHAP4_STATUS_CODE_UNKNOWN_RECIPIENT,
            self::CHAP4_STATUS_CODE_RECALCITRANT_ACCOUNT_HOLDER,
            self::CHAP4_STATUS_CODE_NONREPORTING_IGAFII,
            self::CHAP4_STATUS_CODE_DIRECT_REPORTING_NFFE,
            self::CHAP4_STATUS_CODE_US_REPORTABLE_ACCOUNT,
            self::CHAP4_STATUS_CODE_NON_CONSENTING_US_ACCOUNT,
            self::CHAP4_STATUS_CODE_SPONSORED_DIRECT_REPORTING_NFFE,
            self::CHAP4_STATUS_CODE_EXCEPTED_INTER_AFFILIATE_FFI,
            self::CHAP4_STATUS_CODE_UNDOCUMENTED_PREEXISTING_OBLIGATION,
            self::CHAP4_STATUS_CODE_US_BRANCH_ECI_PRESUMPTION_APPLIED,
            self::CHAP4_STATUS_CODE_ACCOUNT_HOLDER_OF_EXCLUDED_FINANCIAL_ACCOUNT,
            self::CHAP4_STATUS_CODE_PASSIVE_NFFE_REPORTED_BY_FFI,
            self::CHAP4_STATUS_CODE_NFFE_SUBJECT_TO1472_WITHHOLDING,
            self::CHAP4_STATUS_CODE_RECALCITRANT_POOL_NO_US_INDICIA,
            self::CHAP4_STATUS_CODE_RECALCITRANT_POOL_US_INDICIA,
            self::CHAP4_STATUS_CODE_RECALCITRANT_POOL_DORMANT_ACCOUNT,
            self::CHAP4_STATUS_CODE_RECALCITRANT_POOL_US_PERSONS,
            self::CHAP4_STATUS_CODE_RECALCITRANT_POOL_PASSIVE_NFF_ES,
            self::CHAP4_STATUS_CODE_NONPARTICIPATING_FFI_POOL,
            self::CHAP4_STATUS_CODE_US_PAYEES_POOL,
            self::CHAP4_STATUS_CODE_QI_RECALCITRANT_POOL_GENERAL,
            self::CHAP4_STATUS_CODE_US_WITHHOLDING_AGENT_FOREIGN_BRANCH_OF_FI,
        ];
    }
    ...
    public function setRecipientName($recipient_name)
    {
        ...
        if ((mb_strlen($recipient_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recipient_name when calling Form1042SListItem., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Form1042SListItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Form1042SListItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling Form1042SListItem., must be bigger than or equal to 1.');
        }

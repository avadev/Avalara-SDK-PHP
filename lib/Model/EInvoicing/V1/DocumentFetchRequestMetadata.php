...
/**
 * DocumentFetchRequestMetadata Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class DocumentFetchRequestMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentFetchRequest_metadata';
     ...
     *
     * @param float $data_format_version Specifies the data format version number
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string $country_code The two-letter ISO-3166 country code for the country for which document is being retrieved
     *
     * @return self
     */

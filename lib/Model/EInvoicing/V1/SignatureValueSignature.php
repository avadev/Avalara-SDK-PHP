...
/**
 * SignatureValueSignature Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class SignatureValueSignature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignatureValue_signature';
     ...
     * Sets algorithm
     *
     * @param string $algorithm The algorithm used to create the signature.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Signature of the message.
     *
     * @return self
     */

...
class ReportListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'at_next_link' => 'string',
        'value' => '\AvalaraSDK\Model\EInvoicing\V1\ReportItem[]'
    ];
     ...
     * Gets value
     *
     * @return \AvalaraSDK\Model\EInvoicing\V1\ReportItem[]
     */
     ...
     * Sets value
     *
     * @param \AvalaraSDK\Model\EInvoicing\V1\ReportItem[] $value Array of reports matching the query parameters.
     *
     * @return self
     */

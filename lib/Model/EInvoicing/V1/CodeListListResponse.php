...
/**
 * CodeListListResponse Class Doc Comment
 *
 * @category Class
 * @description Returns the requested list of code lists
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CodeListListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CodeListListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'at_next_link' => 'string',
        'value' => '\Avalara\SDK\Model\EInvoicing\V1\CodeListSummary[]'
    ];
     ...
     *
     * @param string|null $at_recordset_count Count of code lists for the given query parameters
     *
     * @return self
     */
     ...
     * Gets value
     *
     * @return \Avalara\SDK\Model\EInvoicing\V1\CodeListSummary[]
     */
     ...
     * Sets value
     *
     * @param \Avalara\SDK\Model\EInvoicing\V1\CodeListSummary[] $value Array of code lists matching query parameters
     *
     * @return self
     */

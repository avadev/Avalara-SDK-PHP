...
/**
 * TaxIdentifierResponseValue Class Doc Comment
 *
 * @category Class
 * @package  Avalara\SDK
 * @author   OpenAPI Generator team
 ...
 */
class TaxIdentifierResponseValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxIdentifierResponse_value';
     ...
     *
     * @param string|null $identifier_type Type of the identifier.
     *
     * @return self
     */
     ...
     * Sets identifier
     *
     * @param string|null $identifier The tax identifier of the company.
     *
     * @return self
     */
     ...
     * Sets extensions
     *
     * @param object|null $extensions Optional field containing additional company-related information such as companyName, companyAddress, blockListed, tradeName, and taxPayerType. It may also include other details specific to the given tax authority. Refer to the GET /tax-identifiers/schema API endpoint for the full response structure for a given country.
     *
     * @return self
     */

...
class SubscriptionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'recordset_count' => 'int',
        'at_next_link' => 'string',
        'value' => '\Avalara\SDK\Model\EInvoicing\V1\SubscriptionDetail[]'
    ];
     ...
     *
     * @param int|null $recordset_count The total count of records in the dataset.
     *
     * @return self
     */
     ...
     * Sets at_next_link
     *
     * @param string|null $at_next_link The URL to the next page of results.
     *
     * @return self
     */
     ...
     * Gets value
     *
     * @return \Avalara\SDK\Model\EInvoicing\V1\SubscriptionDetail[]|null
     */
     ...
     * Sets value
     *
     * @param \Avalara\SDK\Model\EInvoicing\V1\SubscriptionDetail[]|null $value The list of subscriptions.
     *
     * @return self
     */

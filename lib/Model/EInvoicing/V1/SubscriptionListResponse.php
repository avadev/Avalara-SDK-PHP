...
class SubscriptionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'recordset_count' => 'int',
        'at_next_link' => 'string',
        'value' => '\AvalaraSDK\Model\EInvoicing\V1\SubscriptionDetail[]'
    ];
     ...
     * Gets value
     *
     * @return \AvalaraSDK\Model\EInvoicing\V1\SubscriptionDetail[]|null
     */
     ...
     * Sets value
     *
     * @param \AvalaraSDK\Model\EInvoicing\V1\SubscriptionDetail[]|null $value The list of subscriptions.
     *
     * @return self
     */

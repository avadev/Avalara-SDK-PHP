...
**state_and_local_withholding_secondary** | [**\Avalara\SDK\Model\A1099\V2\StateAndLocalWithholding**](StateAndLocalWithholding.md) | Secondary state and local withholding slot. | [optional]

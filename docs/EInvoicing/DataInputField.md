...
**required_for** | [**\AvalaraSDK\Model\EInvoicing\V1\DataInputFieldRequiredFor**](DataInputFieldRequiredFor.md) |  | [optional]
**conditional_for** | [**\AvalaraSDK\Model\EInvoicing\V1\ConditionalForField[]**](ConditionalForField.md) |  | [optional]
**not_used_for** | [**\AvalaraSDK\Model\EInvoicing\V1\DataInputFieldNotUsedFor**](DataInputFieldNotUsedFor.md) |  | [optional]
**optional_for** | [**\AvalaraSDK\Model\EInvoicing\V1\DataInputFieldOptionalFor**](DataInputFieldOptionalFor.md) |  | [optional]

...
```php
downloadReport($avalara_version, $report_id, $x_avalara_client, $x_correlation_id): \AvalaraSDK\ModelEInvoicingV1\ReportDownloadResponse
```
...
[**\AvalaraSDK\ModelEInvoicingV1\ReportDownloadResponse**](../Model/ReportDownloadResponse.md)
...
```php
getReportById($avalara_version, $report_id, $x_avalara_client, $x_correlation_id): \AvalaraSDK\ModelEInvoicingV1\ReportItem
```
...
[**\AvalaraSDK\ModelEInvoicingV1\ReportItem**](../Model/ReportItem.md)
...
```php
getReports($avalara_version, $x_avalara_client, $x_correlation_id, $filter, $top, $skip, $count, $count_only, $orderby): \AvalaraSDK\ModelEInvoicingV1\ReportListResponse
```
...
[**\AvalaraSDK\ModelEInvoicingV1\ReportListResponse**](../Model/ReportListResponse.md)

...
**supported_document_statuses** | [**\AvalaraSDK\ModelEInvoicingV1\SupportedDocumentStatuses[]**](SupportedDocumentStatuses.md) | List of document statuses defined by the mandate. | [optional]
